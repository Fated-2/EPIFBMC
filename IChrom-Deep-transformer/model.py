...
def IChrom_seq_transformer(input_shape_x_forward, input_shape_x_reverse, input_shape_y_forward, input_shape_y_reverse):
    input_data_x_forward = Input(shape=input_shape_x_forward)
    input_data_x_reverse = Input(shape=input_shape_x_reverse)
    input_data_y_forward = Input(shape=input_shape_y_forward)
    input_data_y_reverse = Input(shape=input_shape_y_reverse)
    ...
    merge1 = Concatenate(axis=1)([x_forward, x_reverse, y_forward, y_reverse])
    transfor = Transformer(encoder_stack=2,
                           feed_forward_size=16,
                           n_heads=4,
                           model_dim=64)
    merge1 = transfor(merge1)
...
def IChrom_deep_transformer(input_shape_x_forward, input_shape_x_reverse, input_shape_y_forward, input_shape_y_reverse,
                input_shape_genomics):
    input_data_x_forward = Input(shape=input_shape_x_forward)
    input_data_x_reverse = Input(shape=input_shape_x_reverse)
    input_data_y_forward = Input(shape=input_shape_y_forward)
    ...
    merge1 = Concatenate(axis=1)([x_forward, x_reverse, y_forward, y_reverse])
    transfor = Transformer(encoder_stack=4,
